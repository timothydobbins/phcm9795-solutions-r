...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{descriptives}\NormalTok{(}\AttributeTok{data=}\NormalTok{bp, }\AttributeTok{vars=}\FunctionTok{c}\NormalTok{(bp\_before\_mmhg, bp\_after\_mmhg),}
             \AttributeTok{pc=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
##  Descriptives                                              
##  ───────────────────────────────────────────────────────── 
##                          bp_before_mmhg    bp_after_mmhg   
##  ───────────────────────────────────────────────────────── 
##    N                                 15               15   
##    Missing                            0                0   
##    Mean                        146.4667         129.2667   
##    Median                      144.0000         128.0000   
##    Standard deviation          10.75617         6.902036   
##    Minimum                     139.0000         118.0000   
##    Maximum                     183.0000         140.0000   
##    25th percentile             140.5000         125.5000   
##    50th percentile             144.0000         128.0000   
##    75th percentile             146.5000         132.5000   
##  ─────────────────────────────────────────────────────────
\end{verbatim}
